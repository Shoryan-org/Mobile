...
/// No mockup was provided for this screen specifically — it's built by
/// reusing the "Nearby blood banks" data + [BloodBankTile] widget that
/// already exist from the Home screen, since Profile's "Saved centers"
/// row needs exactly the same data.
